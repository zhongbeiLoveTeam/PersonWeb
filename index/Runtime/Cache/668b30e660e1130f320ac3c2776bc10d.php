...
<script type="text/javascript">
    ...
    function createMap(){
        ...
        var point = new BMap.Point(117.209924,39.097373);//定义一个中心点坐标
   ...
   //标注点数组（重点）
    var markerArr = [{title:"天津XX公司",content:"天津市河西区",point:"117.209466|39.098102",isOpen:1,icon:{w:21,h:21,l:0,t:0,x:6,lb:5}}
         ];
    //创建marker
    function addMarker(){
